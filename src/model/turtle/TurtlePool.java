...
public class TurtlePool extends SLogoObservable<PoolInfo> implements PoolInfo {
    ...
    private Map<Integer, Stamp> myStamps;
	...
	@Override
	public void stamp(double x, double y, int image) {
		myStamps.put(++newIndex, new Stamp(x, y, image));
	}

	@Override
	public boolean clearstamp() {
		boolean ret = !myStamps.isEmpty();
		newIndex = -1;
		myStamps.clear();
		return ret;
	}
