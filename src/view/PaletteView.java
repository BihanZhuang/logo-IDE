...
/**
 * Displays the view to change pen color and background color.
 * Allows user to add new colors into the workspace.
 * @author zhuangbihan
 *
 */
public class PaletteView extends View<VBox> implements SLogoObserver<PaletteInfo> {
    ...
    /**
     * When there is a change to the palette, update the list of colors in
     * the view.
     */
    @Override
